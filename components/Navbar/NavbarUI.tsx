...
const NavbarUI = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 py-2 px-6 text-sm text-slate-500 md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
          <div className="col-span-2 items-center md:col-span-4 lg:col-span-6">
            <a
              ...
              className="flex items-center gap-2 transition-colors duration-300 hover:text-indigo-500"
            >
              <svg
      ...
      {/*<!-- Header --> */}
      <header className="debug border-b-1 relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        ...
        <div className="w-full px-10">
          ...
          >
            ...
            <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:p-0">
              <Link
                href="/cart"
                className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-lg text-indigo-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
                ...
                <span className="absolute -top-1.5 -right-1.5 inline-flex items-center justify-center gap-1 rounded-full border-2 border-white bg-pink-500 px-1.5 text-sm text-white">
                  ...
                  {/* TODO implementar un estado para el numero */}
                </span>
              </Link>
            </div>
          </nav>
