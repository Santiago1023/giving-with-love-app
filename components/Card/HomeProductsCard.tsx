...
const HomeProductsCard = () => {
  return (
    <div className="debug flex flex-col items-center justify-center max-w-[900px] m-auto gap-4 bg-white">
        {/* <div className='debug grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 m-auto md:gap-5 sm:gap-3 gap-1 max-w-[900px] bg-white'> */}
        <div className='debug grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-5 sm:gap-3 gap-1 shadow-lg'>
